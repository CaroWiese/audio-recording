...
const dataMapper = {
  ...
  // dedicated methods, explicit names to retrieve data
  // responsability of the dataMapper ends there, 
  // it's the controller which manages data treatment
  // this treatment will be done with help of the callback
  ...
  // if there's a database error, callback transmitting the eroor is triggered
